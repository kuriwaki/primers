...
* `summarize()`, which help you use your data to compute summary statistics
* `mutate()`, which help you to append new variables to your dataset as a combination of existing ones. 
...
The `summarize()` command provides summaries of existing variables, but we often want to transform our variables without summarizing them. These can be as simple as translating the units of variables from meters to killometers, or creating a new variable that is the sum or ratio of the other two variables. 
